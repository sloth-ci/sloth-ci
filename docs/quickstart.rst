...
Create a file called :download:`sloth.yml <_samples/sloth.yml>` in any directory:
...
.. image:: _images/repo-settings.png
...
.. literalinclude:: _samples/timestamper-logged.yml
    :emphasize-lines: 11-16
    :language: yaml
    :caption: :download:`timestamper-logged.yml <_samples/timestamper-logged.yml>`
